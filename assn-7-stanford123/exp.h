 ...
 * Usage: Expression *exp = new IntegerExp(value);
 * -------------------------------------------------
...
private:
   double value;                   /* The value of the integer constant */
};
 ...
 * ------------------------------------------------
 * The constructor creates a new function(range) expression.
 */

    FunctionExp(string s);
...
private:
    std::string name;              /* The value of the text string constant */
};
