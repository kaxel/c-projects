...
private:
    ...
    Map <string, string> fullcontext;
    Map <string, Set<string>> related;

    bool hasIdentifier(string s);
    Vector <string> identifiers(string s);
    void setCell(string cellname, string s);
    void cellRecalcs(string cellname, TokenScanner& scanner, Expression*& exp);
    void setCellfromString(const string& cellname, string& fullstring, double& value);
    void printToScreen(const string& cellname, string& fullstring, double& value);
